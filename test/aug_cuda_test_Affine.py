...
from medvision.aug_cuda import CudaRandomAffine, CudaDisplay, CudaViewer
...
def test2d():
    ...
    transform = CudaRandomAffine(p=1.0, scale=0.2, shift=0.2, rotate=[20, 40])
    tic = time.time()
...
if __name__ == "__main__":
    ...
    save_to = os.path.join(__dir__, 'CudaRandomAffine')

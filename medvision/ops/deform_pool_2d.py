...
class DeformRoIPooling2dFunction(Function):
    ...
    def forward(ctx,
        ...
        _C.deform_psroi_pooling_cuda_forward(
    ...
    def backward(ctx, grad_output):
        ...
        _C.deform_psroi_pooling_cuda_backward(
...
deform_roi_pooling = DeformRoIPooling2dFunction.apply
...
class DeformRoIPooling2dPack(DeformRoIPooling2d):
...
class ModulatedDeformRoIPooling2dPack(DeformRoIPooling2d):
    ...
    def __init__(self,
                 ...
                 num_mask_fcs=2,
                 deform_fc_channels=1024):
        super(ModulatedDeformRoIPooling2dPack,
              self).__init__(spatial_scale, out_size, out_channels, no_trans,
                             group_size, part_size, sample_per_part, trans_std)

...
void affine_3d_forward_cuda(
  ...
  Affine3DForwardCUDAKernelLauncher(
...
void affine_3d(Tensor input, Tensor rois, Tensor output,
               int aligned_depth, int aligned_height, int aligned_width,
...
//    CHECK_CUDA_INPUT(output);
    ...
    affine_3d_forward_cuda(input, rois, output, aligned_depth, aligned_height,

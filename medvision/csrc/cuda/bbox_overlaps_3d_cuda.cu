#include "bbox_overlaps_3d_cuda_kernel.cuh"

using namespace at;

void bbox_overlaps_3d_cuda(const Tensor bboxes1, const Tensor bboxes2,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      bboxes1.scalar_type(), "bbox_overlaps_3d_cuda_kernel", ([&] {
        bbox_overlaps_3d_cuda_kernel<scalar_t>

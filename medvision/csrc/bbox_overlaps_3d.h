...
void bbox_overlaps_3d_cuda(const at::Tensor bboxes1, const at::Tensor bboxes2,
                                    at::Tensor ious, const int mode,
                                    const bool aligned, const int offset);

void bbox_overlaps_3d(const at::Tensor bboxes1, const at::Tensor bboxes2, at::Tensor ious,
...
//    CHECK_CUDA_INPUT(ious);
    ...
    bbox_overlaps_3d_cuda(bboxes1, bboxes2, ious, mode, aligned, offset);
#else
